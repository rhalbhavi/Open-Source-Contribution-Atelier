...
class MaintainerExpertise(models.Model):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='expertise')
    
    # Domains
    primary_domains = models.ManyToManyField(ExpertiseDomain, related_name='primary_experts')
    secondary_domains = models.ManyToManyField(ExpertiseDomain, related_name='secondary_experts', blank=True)
...
class IssueRouting(models.Model):
    ...
    # Routing results
    suggested_maintainers = models.JSONField(default=list)  # List of user IDs with scores
    primary_assignee = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='primary_routed')
    secondary_assignees = models.ManyToManyField(User, related_name='secondary_routed', blank=True)
