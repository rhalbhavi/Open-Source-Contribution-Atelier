    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payout_id', models.CharField(blank=True, help_text='Stripe transfer/payout ID', max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('bounty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='claims', to='billing.bounty')),
        ...
        migrations.AddField(
            model_name='bounty',
            name='sponsor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bounties', to='billing.organizationsponsor'),
        ),
        migrations.CreateModel(
