...
class CodeIssue(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    review = models.ForeignKey(PRReview, on_delete=models.CASCADE, related_name='issues')
...
class PRReviewComment(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    review = models.ForeignKey(PRReview, on_delete=models.CASCADE, related_name='bot_comments')
