...
class ContributorActivity(models.Model):
    ...
    # Activity trends
    activity_trend = models.FloatField(default=0.0)  # Positive = increasing, Negative = decreasing
    ...
    burnout_risk = models.CharField(max_length=20, default='low')  # low, medium, high, critical
...
class BurnoutSignal(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='burnout_signals')
...
class Intervention(models.Model):
    ...
    signal = models.ForeignKey(BurnoutSignal, on_delete=models.CASCADE, related_name='interventions')
